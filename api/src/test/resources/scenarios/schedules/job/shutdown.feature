...
# ========================================================================================================
# POST method - Shuts down the scheduler - pentaho/api/scheduler/shutdown
# ========================================================================================================
Scenario: A valid <user> calls web service to shuts down the scheduler which is in "Running" state
	Given the <user> has "Schedule Content" permission
	And the scheduler is in "Running" state
	When a HTTP POST request sent to "pentaho/api/scheduler/shutdown"
...
Scenario: A valid user calls web service to shuts down the scheduler, but the scheduler is in "Paused" state
	Given the user has "Schedule Content" permission
...
Scenario: A valid user calls web service to shuts down the scheduler, but do not have "Schedule Content" permission
...
Scenario: A valid <user> calls web service to shuts down the scheduler
