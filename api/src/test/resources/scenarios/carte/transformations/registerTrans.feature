...
# POST Method
# Note: these scenarios are identical to the addTrans endpoint because addTrans is deprecated and this endpoint is its replacement. The document doesn't show any differences in regards to parameters and responses.
...
Scenario Outline: The user calls the web service to upload a transformation to Carte server with the parameter <paramName> having the value <paramValue>.
	...
	And the parameter <paramName> is set to the value <paramValue>
