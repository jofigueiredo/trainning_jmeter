...
# POST Method
# Note: these scenarios are identical to the addJob endpoint because addJob is deprecated and this endpoint is its replacement. The document doesn't show any differences in regards to parameters and responses.
